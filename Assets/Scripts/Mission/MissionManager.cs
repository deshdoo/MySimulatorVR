...
public class MissionManager : MonoBehaviour
{
    ...
    [Tooltip("Клавиша: завершить текущую активную цель (пропуск) — для проверки без зон. " +
             "Отдельная от клавиш кнопок пульта, чтобы не срабатывать вместе с ними.")]
    public Key клавишаЗавершитьЦель = Key.Backspace;
